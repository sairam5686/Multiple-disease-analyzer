...
st.set_page_config(page_title="Mulitple Disease Prediction",layout="wide", page_icon="Sairam.J.R")
...
with st.sidebar:
    selected = option_menu("Mulitple Disease Analyzer", 
                ['Diabetes Prediction',
...
if selected == 'Diabetes Prediction':
    st.title("Diabetes Prediction Using RNN")
...
if selected == 'Heart Disease Prediction':
    st.title("Heart Disease Prediction Using RNN")
    col1, col2, col3  = st.columns(3)
...
if selected == 'Kidney Disease Prediction':
    ...
    st.title("Kidney Disease Prediction using RNN")
